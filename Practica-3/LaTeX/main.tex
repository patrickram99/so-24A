...
\begin{code}
	\captionof{listing}{E1/CMakeLists.txt}
...
\begin{code}
	\captionof{listing}{E1/LinkedList.h}
	\inputminted{c}{../E1/LinkedList.h}
\end{code}

\begin{code}
	\captionof{listing}{E1/LinkedList.cpp}
	\inputminted{cpp}{../E1/LinkedList.cpp}
\end{code}

\begin{code}
	\captionof{listing}{E1/ListNode.cpp}
	\inputminted{cpp}{../E1/ListNode.cpp}
\end{code}

\begin{code}
	\captionof{listing}{E1/ListNode.h}
...
\begin{code}
	\captionof{listing}{E1/proceso.c}
...
\begin{code}
	\captionof{listing}{E1/ejemplo.cpp}
